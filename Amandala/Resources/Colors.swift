...
struct Colors {
    ...
    static let coral = UIColor(hexString: "F9564F")
    static let lightGray = UIColor(hexString: "E6E4E4")
    static let darkGray = UIColor(hexString: "A2A2A2")
    static let gray = UIColor(hexString: "AEAEAE")
    static let grayBackground = UIColor(hexString: "EBEBEB")
